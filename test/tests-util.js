/*global money:false, boxmuller:false */
test("money.fmt args", function() {
    throws( function() { money.fmt('a') ;});
});
test("money.custom args", function() {
    throws( function() { money.custom('a') ;});
});
test("money.custom args", function() {
    throws( function() { money.custom('a','b','c','d') ;});
});
...
test("rand", function() {
    var r = boxmuller.newInstance();
    var rr = r.random();
    ok(!isNaN(rr));
});

test("rand seeded", function() {
    var r1 = boxmuller.newInstance(1);
    var r2 = boxmuller.newInstance(1);
    var rr11 = r1.random();
    var rr21 = r2.random();
    equal(rr11, rr21);
    var rr12 = r1.random();
